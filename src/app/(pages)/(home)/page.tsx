...
const featuresCardsItems = [
	{
		...
		description:
			"Instantly transform any Job Description into a highfidelity evaluation framework. De fine your 'Ideal Candidate' profile, and let our AI build the scoring rubrics.",
	...
	},
	{
		...
		description:
			"No scripts. No repetition. Our Interviewer Agent conducts low-latency, 'human-like' dialogues, probing for depth where it matters most.",
				...
				<div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl lg:mt-32 mb-24 lg:mb-0">
					<div className="max-w-5xl mx-auto text-center">
						<h2 className="mt-6 text-2xl font-semibold tracking-tight text-gray-900 lg:mt-8 sm:text-3xl lg:text-4xl">
							A high-performance Multi-Agent Conversational System engineered to automate complex hiring workflows and
						...
						<div className="flex justify-center mt-12 sm:mt-16">
							<div className="flex flex-col items-center justify-center flex-1 pt-8 space-y-6 border-t border-gray-200 lg:inline-flex md:flex-row md:space-y-0 lg:space-x-12 md:space-x-10">
								<div className="flex items-center">
									...
									<h3 className="ml-2 text-base font-medium text-gray-900">Agentic Pipeline Automation</h3>
								</div>
								<div className="flex items-center">
									<svg
										className="w-6 h-6 text-black"
									...
									<h3 className="ml-2 text-base font-medium text-gray-900">Adaptive Candidate Engagement</h3>
								</div>
								<div className="flex items-center">
									<svg
										className="w-6 h-6 text-black"
									...
									<h3 className="ml-2 text-base font-medium text-gray-900">Multimodal Evidence-based Insights</h3>
								</div>
							</div>
						</div>
					</div>
						...
						<div className="relative grid gap-16 md:grid-cols-3 text-center max-w-6xl mx-auto px-6">
							...
							<div className="space-y-4">
								...
								<p className="text-gray-600 leading-relaxed text-sm max-w-xs mx-auto">
									Reduce screening and interview time with AI-powered, real-time interviews — so your team focuses only
