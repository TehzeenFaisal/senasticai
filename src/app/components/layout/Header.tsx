		...
		<div className="!mt-0 !mb-0">
			<nav className="items-center justify-between mx-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-12 px-4 py-6 mt-2 max-w-7xl">
				...
				<div className="fixed top-0 left-0 w-full z-50 lg:hidden">
					<div className="">
						<div className="flex items-center justify-between h-[60px] backdrop-blur-lg bg-white/60 shadow-[0_4px_20px_rgba(0,0,0,0.08)] border-b border-zinc-200 px-8">
							{/* Logo */}
							...
							<button
								...
								className="flex items-center px-3 py-2 rounded-lg hover:bg-gray-50 active:bg-gray-100 transition-all duration-200 text-gray-700"
							>
				...
				<a className="hidden lg:flex z-50 col-span-2 items-center space-x-2 text-2xl font-bold text-gray-900" href="/">
				...
				<div className="hidden lg:flex col-span-2 justify-end">
					<a
						...
						className="hidden md:flex items-center space-x-2 px-8 py-5 rounded-full font-medium text-white text-sm transition-all duration-300 hover:cursor-pointer bg-[linear-gradient(180deg,_#0E76BC_0%,_#283891_100%)] hover:bg-[linear-gradient(180deg,_#1492E6_0%,_#0E76BC_100%)] shadow-lg hover:shadow-xl hover:scale-[1.02]"
					>
						<svg
					...
					<div className="p-6 h-full flex flex-col">
						...
						<div className="mt-6 pt-6 border-t border-gray-100">
							<a
								onClick={closeMobileMenu}
								href="#contact-section"
								className="gap-2 whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-11 flex items-center justify-center w-full space-x-2 bg-[linear-gradient(180deg,_#0E76BC_0%,_#283891_100%)] hover:bg-[linear-gradient(180deg,_#1492E6_0%,_#0E76BC_100%)] hover:shadow-lg text-white px-8 py-5 rounded-full font-semibold"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
