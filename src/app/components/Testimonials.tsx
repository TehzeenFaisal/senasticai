...
const testimonials: Testimonial[] = [
	{
		id: 1,
		stars: 5,
		text: "Senastic AI transformed our hiring process completely. We've cut our time-to-hire by 60% and the AI-generated insights help us identify top talent we might have missed before. The platform is intuitive and our hiring managers adopted it within days.",
	...
	return (
		<section className="relative px-4 py-24">
			<div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center">
				...
				<div className="lg:col-span-5">
					...
					<div className="flex gap-4">
						<button
							...
							className="rounded-full p-4 border-2 border-black text-black hover:bg-gray-100 transition"
						>
							<svg
				...
				<div className="lg:col-span-7 relative mt-36 lg:mt-14">
					{/* Layered background cards */}
					<div className="absolute bottom-[70px] right-[60px] left-[60px] h-[270px] bg-[#283891]/15 rounded-3xl z-[5] transition-all duration-500"></div>
					<div className="absolute bottom-[55px] right-10 left-10 h-[270px] bg-[#283891]/10 rounded-3xl z-[6] transition-all duration-500"></div>
					<div className="absolute bottom-[40px] right-5 left-5 h-[270px] bg-[#0E76BC]/10 rounded-3xl z-[7] transition-all duration-500"></div>
					<div className="absolute bottom-[25px] -right-0 -left-0 h-[270px] bg-[#0E76BC]/8 rounded-3xl z-[9] transition-all duration-500"></div>
